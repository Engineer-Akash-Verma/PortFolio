# Akash Verma | Full Stack Developer Portfolio

👋 Hi there! Welcome to my GitHub portfolio repository.  
...
I specialize in:
- Backend: C#, ASP.NET Core, SignalR, EF Core
- Frontend: Blazor, Angular, Bootstrap
- Databases: SQL Server, SSMS
- Cloud & Tools: Azure, GitHub, Jira

## 📂 Projects Highlight
- **Rex London Trade** – E-commerce website built on Umbraco and uCommerce  
- **UGM (Union Gospel Mission)** – Nonprofit ministry website  
- **Intelligent Office (Intelliflo)** – Enterprise SaaS product  
